...
def gen_ai_service(context, params = params, **custom):
    ...
    def create_rag_tool(vector_index_id, api_client):
        ...
        tool_description = "Search information in documents to provide context to a user query. Useful when asked to ground the answer in specific knowledge about IBM project"
